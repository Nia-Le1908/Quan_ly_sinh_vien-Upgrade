...
public class SinhVien {
    ...
    private final FloatProperty diemTichLuy; // Thêm thuộc tính điểm tích lũy
    ...
    public SinhVien(String maSV, String hoTen, LocalDate ngaySinh, String gioiTinh, String queQuan, String khoa, String lop) {
        ...
        this.diemTichLuy = new SimpleFloatProperty(0); // Khởi tạo giá trị mặc định
    }
    ...
    public float getDiemTichLuy() { return diemTichLuy.get(); }
    public void setDiemTichLuy(float value) { diemTichLuy.set(value); }
    public FloatProperty diemTichLuyProperty() { return diemTichLuy; }


    // ===== For Debug (Optional) =====
    @Override
    public String toString() {
        return String.format("%s - %s (%s)", getMaSV(), getHoTen(), getLop());
    }
}